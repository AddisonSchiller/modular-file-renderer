...
setup(
    ...
    entry_points={
        ...
        'mfr.exporters': [
            ...
            '.gdoc = mfr.extensions.libreoffice:LibreOfficeExporter',
            '.gsheet = mfr.extensions.libreoffice:LibreOfficeExporter',
            '.gslides = mfr.extensions.libreoffice:LibreOfficeExporter',
            ...
            # unoconv
            # '.bib = mfr.extensions.libreoffice:LibreOfficeExporter',
            # '.bmp = mfr.extensions.libreoffice:LibreOfficeExporter',
            # '.csv = mfr.extensions.libreoffice:LibreOfficeExporter',
            '.dbf = mfr.extensions.libreoffice:LibreOfficeExporter',
            '.dif = mfr.extensions.libreoffice:LibreOfficeExporter',
            '.doc = mfr.extensions.libreoffice:LibreOfficeExporter',
            '.docx = mfr.extensions.libreoffice:LibreOfficeExporter',
            '.emf = mfr.extensions.libreoffice:LibreOfficeExporter',
            '.eps = mfr.extensions.libreoffice:LibreOfficeExporter',
            '.fodg = mfr.extensions.libreoffice:LibreOfficeExporter',
            '.fodp = mfr.extensions.libreoffice:LibreOfficeExporter',
            '.fods = mfr.extensions.libreoffice:LibreOfficeExporter',
            '.fodt = mfr.extensions.libreoffice:LibreOfficeExporter',
            # '.gif = mfr.extensions.libreoffice:LibreOfficeExporter',
            # '.html = mfr.extensions.libreoffice:LibreOfficeExporter',
            # '.jpg = mfr.extensions.libreoffice:LibreOfficeExporter',
            # '.ltx = mfr.extensions.libreoffice:LibreOfficeExporter',
            '.met = mfr.extensions.libreoffice:LibreOfficeExporter',
            '.odd = mfr.extensions.libreoffice:LibreOfficeExporter',
            '.odg = mfr.extensions.libreoffice:LibreOfficeExporter',
            '.odp = mfr.extensions.libreoffice:LibreOfficeExporter',
            '.ods = mfr.extensions.libreoffice:LibreOfficeExporter',
            '.odt = mfr.extensions.libreoffice:LibreOfficeExporter',
            '.otg = mfr.extensions.libreoffice:LibreOfficeExporter',
            '.otp = mfr.extensions.libreoffice:LibreOfficeExporter',
            '.ots = mfr.extensions.libreoffice:LibreOfficeExporter',
            '.ott = mfr.extensions.libreoffice:LibreOfficeExporter',
            '.pbm = mfr.extensions.libreoffice:LibreOfficeExporter',
            '.pct = mfr.extensions.libreoffice:LibreOfficeExporter',
            # '.pdb = mfr.extensions.libreoffice:LibreOfficeExporter',
            # '.pdf = mfr.extensions.libreoffice:LibreOfficeExporter',
            '.pgm = mfr.extensions.libreoffice:LibreOfficeExporter',
            # '.png = mfr.extensions.libreoffice:LibreOfficeExporter',
            '.pot = mfr.extensions.libreoffice:LibreOfficeExporter',
            '.potm = mfr.extensions.libreoffice:LibreOfficeExporter',
            '.ppm = mfr.extensions.libreoffice:LibreOfficeExporter',
            '.pps = mfr.extensions.libreoffice:LibreOfficeExporter',
            '.ppt = mfr.extensions.libreoffice:LibreOfficeExporter',
            '.pptx = mfr.extensions.libreoffice:LibreOfficeExporter',
            '.psw = mfr.extensions.libreoffice:LibreOfficeExporter',
            '.pwp = mfr.extensions.libreoffice:LibreOfficeExporter',
            '.pxl = mfr.extensions.libreoffice:LibreOfficeExporter',
            '.ras = mfr.extensions.libreoffice:LibreOfficeExporter',
            '.rtf = mfr.extensions.libreoffice:LibreOfficeExporter',
            '.sda = mfr.extensions.libreoffice:LibreOfficeExporter',
            '.sdc = mfr.extensions.libreoffice:LibreOfficeExporter',
            '.sdd = mfr.extensions.libreoffice:LibreOfficeExporter',
            '.sdw = mfr.extensions.libreoffice:LibreOfficeExporter',
            '.slk = mfr.extensions.libreoffice:LibreOfficeExporter',
            '.stc = mfr.extensions.libreoffice:LibreOfficeExporter',
            '.std = mfr.extensions.libreoffice:LibreOfficeExporter',
            '.sti = mfr.extensions.libreoffice:LibreOfficeExporter',
            '.stw = mfr.extensions.libreoffice:LibreOfficeExporter',
            '.svg = mfr.extensions.libreoffice:LibreOfficeExporter',
            '.svm = mfr.extensions.libreoffice:LibreOfficeExporter',
            '.swf = mfr.extensions.libreoffice:LibreOfficeExporter',
            '.sxc = mfr.extensions.libreoffice:LibreOfficeExporter',
            '.sxd = mfr.extensions.libreoffice:LibreOfficeExporter',
            '.sxi = mfr.extensions.libreoffice:LibreOfficeExporter',
            '.sxw = mfr.extensions.libreoffice:LibreOfficeExporter',
            # '.tiff = mfr.extensions.libreoffice:LibreOfficeExporter',
            # '.txt = mfr.extensions.libreoffice:LibreOfficeExporter',
            '.uop = mfr.extensions.libreoffice:LibreOfficeExporter',
            '.uos = mfr.extensions.libreoffice:LibreOfficeExporter',
            '.uot = mfr.extensions.libreoffice:LibreOfficeExporter',
            '.vor = mfr.extensions.libreoffice:LibreOfficeExporter',
            '.wmf = mfr.extensions.libreoffice:LibreOfficeExporter',
            '.wps = mfr.extensions.libreoffice:LibreOfficeExporter',
            # '.xhtml = mfr.extensions.libreoffice:LibreOfficeExporter',
            # '.xls = mfr.extensions.libreoffice:LibreOfficeExporter',
            # '.xlsx = mfr.extensions.libreoffice:LibreOfficeExporter',
            '.xlt = mfr.extensions.libreoffice:LibreOfficeExporter',
            # '.xml = mfr.extensions.libreoffice:LibreOfficeExporter',
            '.xpm = mfr.extensions.libreoffice:LibreOfficeExporter',
        ],
        'mfr.renderers': [
            # audio
            ...
            '.gdoc = mfr.extensions.libreoffice:LibreOfficeRenderer',
            '.gsheet = mfr.extensions.tabular:TabularRenderer',
            '.gslides = mfr.extensions.libreoffice:LibreOfficeRenderer',
            ...
            # unoconv
            # '.bib = mfr.extensions.libreoffice:LibreOfficeRenderer',
            # '.bmp = mfr.extensions.libreoffice:LibreOfficeRenderer',
            # '.csv = mfr.extensions.libreoffice:LibreOfficeRenderer',
            '.dbf = mfr.extensions.libreoffice:LibreOfficeRenderer',
            '.dif = mfr.extensions.libreoffice:LibreOfficeRenderer',
            '.doc = mfr.extensions.libreoffice:LibreOfficeRenderer',
            '.docx = mfr.extensions.libreoffice:LibreOfficeRenderer',
            '.emf = mfr.extensions.libreoffice:LibreOfficeRenderer',
            '.eps = mfr.extensions.libreoffice:LibreOfficeRenderer',
            '.fodg = mfr.extensions.libreoffice:LibreOfficeRenderer',
            '.fodp = mfr.extensions.libreoffice:LibreOfficeRenderer',
            '.fods = mfr.extensions.libreoffice:LibreOfficeRenderer',
            '.fodt = mfr.extensions.libreoffice:LibreOfficeRenderer',
            # '.gif = mfr.extensions.libreoffice:LibreOfficeRenderer',
            # '.html = mfr.extensions.libreoffice:LibreOfficeRenderer',
            # '.jpg = mfr.extensions.libreoffice:LibreOfficeRenderer',
            # '.ltx = mfr.extensions.libreoffice:LibreOfficeRenderer',
            '.met = mfr.extensions.libreoffice:LibreOfficeRenderer',
            '.odd = mfr.extensions.libreoffice:LibreOfficeRenderer',
            '.odg = mfr.extensions.libreoffice:LibreOfficeRenderer',
            '.odp = mfr.extensions.libreoffice:LibreOfficeRenderer',
            '.ods = mfr.extensions.libreoffice:LibreOfficeRenderer',
            '.odt = mfr.extensions.libreoffice:LibreOfficeRenderer',
            '.otg = mfr.extensions.libreoffice:LibreOfficeRenderer',
            '.otp = mfr.extensions.libreoffice:LibreOfficeRenderer',
            '.ots = mfr.extensions.libreoffice:LibreOfficeRenderer',
            '.ott = mfr.extensions.libreoffice:LibreOfficeRenderer',
            '.pbm = mfr.extensions.libreoffice:LibreOfficeRenderer',
            '.pct = mfr.extensions.libreoffice:LibreOfficeRenderer',
            # '.pdb = mfr.extensions.libreoffice:LibreOfficeRenderer',
            # '.pdf = mfr.extensions.libreoffice:LibreOfficeRenderer',
            '.pgm = mfr.extensions.libreoffice:LibreOfficeRenderer',
            # '.png = mfr.extensions.libreoffice:LibreOfficeRenderer',
            '.pot = mfr.extensions.libreoffice:LibreOfficeRenderer',
            '.potm = mfr.extensions.libreoffice:LibreOfficeRenderer',
            '.ppm = mfr.extensions.libreoffice:LibreOfficeRenderer',
            '.pps = mfr.extensions.libreoffice:LibreOfficeRenderer',
            '.ppt = mfr.extensions.libreoffice:LibreOfficeRenderer',
            '.pptx = mfr.extensions.libreoffice:LibreOfficeRenderer',
            '.psw = mfr.extensions.libreoffice:LibreOfficeRenderer',
            '.pwp = mfr.extensions.libreoffice:LibreOfficeRenderer',
            '.pxl = mfr.extensions.libreoffice:LibreOfficeRenderer',
            '.ras = mfr.extensions.libreoffice:LibreOfficeRenderer',
            '.rtf = mfr.extensions.libreoffice:LibreOfficeRenderer',
            '.sda = mfr.extensions.libreoffice:LibreOfficeRenderer',
            '.sdc = mfr.extensions.libreoffice:LibreOfficeRenderer',
            '.sdd = mfr.extensions.libreoffice:LibreOfficeRenderer',
            '.sdw = mfr.extensions.libreoffice:LibreOfficeRenderer',
            '.slk = mfr.extensions.libreoffice:LibreOfficeRenderer',
            '.stc = mfr.extensions.libreoffice:LibreOfficeRenderer',
            '.std = mfr.extensions.libreoffice:LibreOfficeRenderer',
            '.sti = mfr.extensions.libreoffice:LibreOfficeRenderer',
            '.stw = mfr.extensions.libreoffice:LibreOfficeRenderer',
            '.svg = mfr.extensions.libreoffice:LibreOfficeRenderer',
            '.svm = mfr.extensions.libreoffice:LibreOfficeRenderer',
            '.swf = mfr.extensions.libreoffice:LibreOfficeRenderer',
            '.sxc = mfr.extensions.libreoffice:LibreOfficeRenderer',
            '.sxd = mfr.extensions.libreoffice:LibreOfficeRenderer',
            '.sxi = mfr.extensions.libreoffice:LibreOfficeRenderer',
            '.sxw = mfr.extensions.libreoffice:LibreOfficeRenderer',
            # '.tiff = mfr.extensions.libreoffice:LibreOfficeRenderer',
            # '.txt = mfr.extensions.libreoffice:LibreOfficeRenderer',
            '.uop = mfr.extensions.libreoffice:LibreOfficeRenderer',
            '.uos = mfr.extensions.libreoffice:LibreOfficeRenderer',
            '.uot = mfr.extensions.libreoffice:LibreOfficeRenderer',
            '.vor = mfr.extensions.libreoffice:LibreOfficeRenderer',
            '.wmf = mfr.extensions.libreoffice:LibreOfficeRenderer',
            '.wps = mfr.extensions.libreoffice:LibreOfficeRenderer',
            # '.xhtml = mfr.extensions.libreoffice:LibreOfficeRenderer',
            # '.xls = mfr.extensions.libreoffice:LibreOfficeRenderer',
            # '.xlsx = mfr.extensions.libreoffice:LibreOfficeRenderer',
            '.xlt = mfr.extensions.libreoffice:LibreOfficeRenderer',
            # '.xml = mfr.extensions.libreoffice:LibreOfficeRenderer',
            '.xpm = mfr.extensions.libreoffice:LibreOfficeRenderer',
